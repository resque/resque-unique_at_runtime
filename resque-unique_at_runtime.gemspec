...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/resque/unique_at_runtime/version.rb", mod) }::Resque::UniqueAtRuntime::Version::VERSION
  else
    require_relative "lib/resque/unique_at_runtime/version"
    Resque::UniqueAtRuntime::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "resque-unique_at_runtime"
  spec.version = gem_version
  spec.authors = ["Peter H. Boling", "Jonathan R. Wallace", "Tatsuhiko Miyagawa", "Lance Woodson", "Daniel Cunha", "jiikko"]
  ...
  desc
  spec.homepage = "https://github.com/resque/resque-unique_at_runtime"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://resque-unique-at-runtime.galtzo.com"
